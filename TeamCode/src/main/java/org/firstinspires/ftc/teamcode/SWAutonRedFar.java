...
public class SWAutonRedFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Mirror of Blue: .turn(+35) becomes .turn(-35) so we rotate toward F6 (right goal)
        ...
        Actions.runBlocking(withPoseTelemetry(moveRows3TurnAndShootPose, drive, nShooter, false));
        ...
        //Action poseBackToD5FromShootingPoseAfterF4 = GoToPose(shootingPoseNear, drive, poseAtD5);
        Actions.runBlocking(withPoseTelemetry(
                new SequentialAction(
                        burstF4
                        //,poseBackToD5FromShootingPoseAfterF4
                ),
                drive, nShooter, true
        ));
        ...
        Action poseBackToShootingPoseFromF2 = GoToPose(poseAtF2, drive, startPose); //GoToPose(fromPose, drive, toPose) Go to from currentpose to a new topose
        ...
        //Action poseBackToD5FromShootingPoseAfterF2 = GoToPose(shootingPoseNear, drive, poseAtD5);
        Actions.runBlocking(withPoseTelemetry(
                new SequentialAction(
                        burstF2
                        //,poseBackToD5FromShootingPoseAfterF2
                ),
                drive, fShooter, true
        ));
    ...
    // ==== Helpers (same as Blue, just copied here) =====================================
