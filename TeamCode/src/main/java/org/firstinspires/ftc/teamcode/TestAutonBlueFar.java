...
@Autonomous(name = "Test Shockwave Auton Blue Far", group = "Auto")
public class TestAutonBlueFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        double targetX_C4 = startPose.position.x - 2.6 * tile;
...
//        ));
        ...
        Action poseToStartPoseAsShootingPoseFromA2 = utils.GoToPose(poseAtA2, drive, startPose);
