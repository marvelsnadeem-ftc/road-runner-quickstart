...
@Autonomous(name = "Test Shockwave Auton Red Far", group = "Auto")
public class TestAutonRedFar extends LinearOpMode {
...
//        ));
        ...
        Action poseToStartPoseAsShootingPoseFromF2 = utils.GoToPose(poseAtF2, drive, startPose);
        ...
        Actions.runBlocking(utils.withPoseTelemetry(
                poseToStartPoseAsShootingPoseFromF2WithVision, drive, nShooter, false
        ));
